...
function HomeSection() { 
  return (
    ...
    <p className="home-text">
        Here is some text. this is about what i want to be talking about. this is what is about me. this is my intro. Here is some text. this is about what i want to be talking about. this is what is about me. this is my intro.
    </p>
